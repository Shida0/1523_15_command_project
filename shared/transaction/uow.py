...
class AbstractRepository(ABC):
    """Abstract base class для type hints"""
    @abstractmethod
...
class UnitOfWork:
    """
    Unit of Work для управления транзакциями. Использовать его можно только через контекстный менеджер.
    Принимает session_factory, не отдельную сессию. Сделано так специально, чтобы сократить код
    """
